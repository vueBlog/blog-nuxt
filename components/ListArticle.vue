<template>
  <div class="item-box">
    ...
    <router-link class="content" :to="articleLink"
      >{{ info.articleSubTitle }}...</router-link
    >
    <div class="footer clearfix">
      ...
      <div class="footer-item">
        views <span>{{ info.articleView }}</span>
      </div>
      <div class="footer-line"></div>
      <div class="footer-item">
        stars <span>{{ info.articleStart }}</span>
      </div>
      <div v-if="editAuthority" class="footer-editor fr">
        <router-link class="footer-item" :to="articleEditorLink"
          >编辑</router-link
        >
        <div class="footer-line"></div>
...
export default {
  ...
  computed: {
    ...
    editAuthority() {
      return (
        this.signStatus &&
        (this.userInfo.id === this.info.articleAuthorId || this.userInfo.admin)
      )
    },
    articleType() {
      let result
