  ...
  <div class="header clearfix">
    ...
    <div class="fr clearfix">
      ...
      >
        ...
        <template v-else>
          <el-menu-item index="5" route="/editor">写新文章</el-menu-item>
          <el-submenu index="6">
            <template slot="title">
              <div class="user-box clearfix">
                <img
                  class="user-box_header-img fl"
                  :src="authorImg"
                  alt="用户头像"
                />
            ...
            <el-menu-item index="6-1" :route="`/admin/${userInfo.id}`"
              >个人中心</el-menu-item
            >
            <el-menu-item index="6-2" route="/admin/column"
              >文章专栏</el-menu-item
            >
            ...
            <el-menu-item
              ...
              >授权</el-menu-item
            >
            <el-menu-item v-if="userInfo.admin" index="6-5" route="/admin/ad"
              >广告位</el-menu-item
            >
...
export default {
  ...
  computed: {
    ...
    authorImg() {
      return this.userInfo.authorHeadimg
        ? this.userInfo.authorHeadimg
  ...
  methods: {
    ...
    async querySearchAsync(queryString, cb) {
      ...
      const result = await this.$axios.post(api.search, {
        queryString,
      })
      if (result.isok) {
